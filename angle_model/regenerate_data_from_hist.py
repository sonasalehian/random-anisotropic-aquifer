...
generated_data = generate_data_from_histogram(bin_edges_original, frequencies_original, num_samples_generated)
...
print(f"Summary statistics for generated data: Mean={mean_generated:.2f}, Standard Deviation={std_generated:.2f}")

# Plot original histogram
plt.figure(figsize=(10, 5))
plt.subplot(1, 2, 1)
plt.bar(bin_edges_original[:-1], frequencies_original, width=np.diff(bin_edges_original), align='edge', color='blue', alpha=0.7, label='Original histogram')
plt.xlabel('Value')
