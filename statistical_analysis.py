...
def calculate_statistics(data):
    ...
    return mean, mode, median, data_range, quartiles, iqr, variance, std_deviation
...
def statistical_analysis(file_path):    
    ...
    mean, mode, median, data_range, quartiles, iqr, variance, std_deviation = calculate_statistics(results)
